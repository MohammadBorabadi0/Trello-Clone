...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`min-h-fit border-r border-gray-200 text-white ${
        showSidebar ? "w-[300px]" : "w-4"
    ...
    >
      ...
      <section className={`${showSidebar ? "block" : "hidden"} py-3`}>
        ...
        <div className="h-60 flex justify-center items-center">
          <button className="flex items-center gap-3 bgc-gradient px-4 py-2 mx-3 rounded-md">
            <BsTrello />
            Try Premium Free
          </button>
        </div>
